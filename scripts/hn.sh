...
# train_data_folder=$DATA_PATH/data/training_data/t5-base-marco-documents-2048-bkt-hncn
train_data_folder=/compute/babel-4-7/luoqic/t5-base-marco-documents-2048-bkt-hncn
...
#     --hn_file $DATA_PATH/data/negatives/t5-base-marco-documents-2048-bkt-hncn/combined_negatives.txt \
#     --qrels $train_qrels \
...
cat $train_data_folder/*.hncn.jsonl > $train_data_folder/full.jsonl
rm $train_data_folder/*.hncn.jsonl
