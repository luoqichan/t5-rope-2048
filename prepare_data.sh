downloads_directory="/data/user_data/luoqic/DRhard/data/doc/dataset"
...
# unzip https://thunlp.oss-cn-qingdao.aliyuncs.com/OpenMatch/MSMARCO/document_ranking/bids_marco-doc_ance-maxp-10.tsv.zip -d "$downloads_directory"
